...
public interface ProductoDAO {
	...
	/*public Boolean exists(Connection connection, String email) 
       ...
       public Producto create (Connection c, Producto p)
		throws    DataException;
	...
	public void update (Connection c, Producto p)
		throws  InstanceNotFoundException, DataException;


	void deleteById(Connection c, Long id) 
			throws InstanceNotFoundException, DataException;

	public List<Producto> findByCriteria(Connection c, ProductoCriteria criteria) throws DataException;
