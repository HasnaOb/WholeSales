...
public class ConnectionManager {
	...
	static {
		DRIVER_CLASS = ConfigurationManager.getInstance().getParameter(ConstantConfigUtils.WHOLESALES_PROPERTIES, CLASE);
		DB_URL = ConfigurationManager.getInstance().getParameter(ConstantConfigUtils.WHOLESALES_PROPERTIES, URL);
		DB_USER =ConfigurationManager.getInstance().getParameter(ConstantConfigUtils.WHOLESALES_PROPERTIES, USER);
		DB_PASSWORD = ConfigurationManager.getInstance().getParameter(ConstantConfigUtils.WHOLESALES_PROPERTIES, PASSWORD);
		try {
