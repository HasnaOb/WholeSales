...
//				throws DataException;
	...
	/*
	 * public Boolean exists(Connection connection, PedidoDTO p) throws
	 * DataException;
	 */

	public PedidoDTO create(Connection c, PedidoDTO p) throws DataException;

	public void update(Connection c, PedidoDTO p) throws InstanceNotFoundException, DataException;
